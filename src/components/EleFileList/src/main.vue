    ...
    <div v-if="grid" class="ele-file-list">
      ...
      <div v-if="showCheckbox" class="ele-file-list-header">
        <div class="ele-file-list-check-group" @click.stop="allChecked=!allChecked">
          ...
          <span v-if="checked.length">{{ t('ele.fileList.selectTips', {total: checked.length}) }}</span>
          <span v-else>{{ t('ele.fileList.selectAll') }}</span>
        </div>
      </div>
      <!-- item -->
      <div
    ...
    <div v-else class="ele-file-list-table">
        ...
        <div class="ele-file-list-table-item-body">
          ...
          <div class="ele-file-list-table-item-name" @click="onSortChange('name')">
            <span v-if="!checked.length">
              <span>{{ t('ele.fileList.fileName') }}</span>
            ...
            <span v-else @click.stop="allChecked=!allChecked">
              {{ t('ele.fileList.selectTips', {total: checked.length}) }}
            </span>
          </div>
          <div class="ele-file-list-table-item-size" @click="onSortChange('length')">
            <span>{{ t('ele.fileList.fileSize') }}</span>
            <i :class="getSortClass('length')">
              <i class="ele-border-primary"></i>
              <i class="ele-border-primary"></i>
            </i>
          </div>
          <div class="ele-file-list-table-item-time" @click="onSortChange('createTime')">
            <span>{{ t('ele.fileList.fileTimestamp') }}</span>
            <i :class="getSortClass('createTime')">
              <i class="ele-border-primary"></i>
              <i class="ele-border-primary"></i>
            </i>
          </div>
      ...
      <div
        ...
        <div class="ele-file-list-table-item-body">
          ...
          <!-- 修改时间 -->
          <div class="ele-file-list-table-item-time">{{ item.createTime }}</div>
        </div>
      </div>
    </div>
  </div>
